...
class Customers_model extends CI_Model
{
    ...
    public function get_all($where = array(), $colname = "", $order = "id DESC")
    {
    ...
    public function where_in($ids, $colname = "")
    {
        return $this->db->select($colname)->where_in('id', $ids)->get($this->tableName)->result();
    }


    //Sadece bir kayıt getirecek olan metot.
