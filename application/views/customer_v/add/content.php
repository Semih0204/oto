<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="mb-4">Müşteri Kayıt Bilgileri</h5>
                    ...
                    <form action="<?php echo base_url("admin/customer/save"); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small class="form-text text-muted">Müşteri İsmini Giriniz.</small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" name="email"  value="<?php echo isset($formError) ? set_value("email") : " " ?>" >
                        ...
                        <br>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="adress" class="form-control" name="adress"  value="<?php echo isset($formError) ? set_value("adress") : " " ?>" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control phone" name="phone" value="<?php echo isset($formError) ? set_value("phone") : " " ?>"  placeholder="Cep Telefon Yazınız.">
