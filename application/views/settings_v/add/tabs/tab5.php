   <div id="tab5">
       <div>
           ...
           <div class="form-group row ">
               ...
               <div class="col-sm-10">
                   <textarea class="form-control" rows="5" name="description" placeholder="Arama motorları için açıklama yazınız."></textarea>
           ...
           <div class="form-group row ">
               ...
               <div class="col-sm-10">
                   <textarea class="form-control" rows="5" name="keywords" placeholder="Arama motorları için anahtar kelime yazınız."></textarea>
           ...
           <div class="form-group row ">
               ...
               <div class="col-sm-10">
                   <textarea class="form-control" rows="5" name="googleMap" placeholder="Konumun gösterilebilmesi için Google Konum bilgisini yazınız."></textarea>
           ...
           <div class="form-row">
               <div class="form-group col-md-6">
                   ...
                   <input type="text" class="form-control" name="author" placeholder="ABC Güzellik Merkezinin Randevu Sistemi">
               ...
               <div class="form-group col-md-6">
                   ...
                   <input type="text" class="form-control" name="googleAnalystic" placeholder="Google tarafından verilen Analystic kodunu yazınız.">
