<div id="tab1">
    <div>
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="companyName" value="<?php echo $item->companyName; ?>" placeholder="Şirket İsmini Yazınız.">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="url" value="<?php echo $item->url; ?>" placeholder="Web Sitesi İsmini Yazınız.">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="title" value="<?php echo $item->title; ?>" placeholder="Web Sitesi İsmini Yazınız.">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " name="workingHours" value="<?php echo $item->workingHours; ?>" placeholder="Web Sitesi İsmini Yazınız.">
