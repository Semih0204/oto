                                ...
                                <div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <textarea class="form-control" rows="5" name="adress" placeholder="Şube Adresini Yazınız."><?php echo $item->adress; ?></textarea>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control onlychar" name="province" value="<?php echo $item->province; ?>" placeholder="İl Yazınız.">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control onlychar" name="district" value="<?php echo $item->district; ?>" placeholder="İlçe Yazınız.">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone " name="phone1" value="<?php echo $item->phone1; ?>" placeholder="Sabit Telefon Yazınız.">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone" name="phone2" value="<?php echo $item->phone2; ?>" placeholder="Sabit Telefon Yazınız(Zorunlu Değildir).">
                                            <small class="form-text text-muted">Şubelerinizin, müşteriler tarafından görülecek sabit telefon numarasını giriniz.</small>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone " name="fax1" value="<?php echo $item->fax1; ?>" placeholder="Fax Numarasını Yazınız(Zorunlu Değildir).">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone" name="fax2" value="<?php echo $item->fax2; ?>" placeholder="Fax Numarasını Yazınız(Zorunlu Değildir).">
                                            <small class="form-text text-muted">Şubelerinizin, müşteriler tarafından görülecek fax numarasını giriniz.</small>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone" name="gsm1" value="<?php echo $item->gsm1; ?>" placeholder="Cep Telefon Yazınız(Zorunlu Değildir).">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control phone" name="gsm2" value="<?php echo $item->gsm2; ?>" placeholder="Cep Telefon Yazınız(Zorunlu Değildir).">
                                            <small class="form-text text-muted">Şubelerinizin, müşteriler tarafından görülecek cep telefon numarasını giriniz.</small>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control " name="email" value="<?php echo $item->email; ?>" placeholder="Şirkete ait email adresi yazınız.">
