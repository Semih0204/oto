        ...
        <div class="col-10">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url("admin/type/update/$item->id"); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            ...
                            <label class="col-sm-2 col-form-label"> <strong> Araç Türü</strong></label>

                            <div class="col-sm-10">
                                <input type="text" class="form-control " name="name"                                 
                                value="<?php echo isset($formError) ? set_value("type") : $item->name; ?>"
                                placeholder="Hizmet İsmini Yazınız.">
                                <small class="form-text text-muted">Araç Türünün Adını Giriniz</small>
