<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1>Araç Seçim Kayıt</h1>

            <!-- Sağ taraftaki butonlar Yeni Ekle - Export -->
            <div class="top-right-button-container">
                <a class="btn btn-outline-success btn-md " aria-haspopup="true" aria-expanded="false" href="<?php echo base_url("admin/service/new_form"); ?>">
                    ...
                    <tbody class="sortable">
                        ...
                        foreach ($items as $item) { ?>
                            <tr class="pull-center-trend" id="ord-<?php echo $item->id; ?>">
                                ...
                                <td><?php echo getCarTypeName($item->id_type); ?></td>
                                <td><?php echo getCarBrandName($item->id_brands); ?></td>
                                ...
                                <td>
                                    ...
                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
                                        ...
                                        type="checkbox" 
                                        data-url="<?php echo base_url("admin/service/isActiveSetter/$item->id"); ?> " 
                                ...
                                <td>
                                    <button data-url="<?php echo base_url("admin/service/delete/$item->id"); ?>" class="btn btn-xs btn-outline-danger mb-1 remove-btn-sweet">
                                        <i class="glyph-icon simple-icon-trash"></i> Sil
                                    </button>

                                    <!-- Düzenleme için id'yi göndermek gereklidir. -->
                                    <a href="<?php echo base_url("admin/service/updateForm/$item->id") ?>" class="btn btn-xs btn-outline-secondary mb-1"><i class="simple-icon-note"></i> Düzenle</a>
                                </td>
