        ...
        <div class="col-10">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url("admin/service/update/$item->id"); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="w-100">
                                        ...
                                        <select name="id_type" required class="form-control select2-single" data-width="100%">
                                            ...
                                            ?>
                                                <option <?php /* if($item->id_type == $type->id){ echo "selected"; } */ echo ($item->id_type == $type->id)? "selected" : ""; ?> value="<?= $type->id ?>"><?php echo "$type->name " ?></option>
                                            <?php } ?>
                                        </select>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="w-100">
                                        ...
                                        <select name="id_brand" required class="form-control select2-single" data-width="100%">
                                            ...
                                            ?>
                                                <option <?php echo ($item->id_brands == $brand->id)? "selected" : ""; ?> value="<?= $brand->id ?>"><?php echo "$brand->name " ?></option>
                                            <?php } ?>
                                        </select>
                                    </label>
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control " name="name" placeholder="Hizmet İsmini Yazınız." value="<?php echo $item->name; ?>">
