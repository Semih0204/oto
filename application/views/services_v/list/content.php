<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1>Hizmet Bilgileri</h1>

            <!-- Sağ taraftaki butonlar Yeni Ekle - Export -->
            <div class="top-right-button-container">
                <a class="btn btn-outline-success btn-md " aria-haspopup="true" aria-expanded="false" href="<?php echo base_url("admin/services/new_form"); ?>">
                    ...
                    <tbody class="sortable">
                        ...
                        foreach ($items as $item) { ?>
                            <tr class="pull-center-trend" id="ord-<?php echo $item->id; ?>">
                                ...
                                <td><img width="90px" src="<?php echo base_url("uploads/{$viewFolder}/$item->image_url"); ?>" alt="<?php echo $item->image_url; ?>" class="img-responsive"></td>
                                <td><?php echo $item->name ?></td>
                                <td><?php echo $item->time; ?></td>
                                <td><?php echo $item->primPuan; ?></td>
                                ...
                                <td>
                                    ...
                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
                                        ...
                                        type="checkbox" 
                                        data-url="<?php echo base_url("admin/services/isActiveSetter/$item->id"); ?> " 
                                ...
                                <td>
                                    ...
                                    <button data-url="<?php echo base_url("admin/services/delete/$item->id"); ?>" class="btn btn-xs btn-outline-danger mb-1 remove-btn-sweet">
                                        <i class="glyph-icon simple-icon-trash"></i> Sil
                                    </button>

                                    <!-- Düzenleme için id'yi göndermek gereklidir. -->
                                    <a href="<?php echo base_url("admin/services/updateForm/$item->id") ?>" class="btn btn-xs btn-outline-secondary mb-1"><i class="simple-icon-note"></i> Düzenle</a>
