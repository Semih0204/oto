<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1>Yeni Hizmet Ekleme İşlemi</h1>
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="mb-4">Yeni Hizmet Bilgileri</h5>

                    <form action="<?php echo base_url("admin/services/save"); ?>" method="POST" enctype="multipart/form-data">

                        <div class="form-group row ">

                            <label class="col-sm-2 col-form-label"> <strong>Hizmet Görseli</strong></label>

                            <div class="col-sm-10">
                                <input type="file" class="form-control " name="image_url">
                                <small class="form-text text-muted">Hizmet için kapak resmi seçiniz. jpg | jpeg | png formatları desteklenmektedir.</small>
                            </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select name="time" class="form-control">
                                    <option value="">Hizmet Süresi Seçiniz</option>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select name="primPuan" class="form-control">
                                    <option value="">Hizmet Prim Puanı Seçiniz</option>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    value="<?php echo isset($formError)? set_value("price"): "" ?>"
                                    placeholder="Hizmet Fiyatını Yazınız.">
