    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="top-right-button-container">
                <a class="btn btn-outline-success btn-md " aria-haspopup="true" aria-expanded="false" href="<?php echo base_url("admin/users/new_form"); ?>">
                    ...
                    <tbody>
                        ...
                        foreach ($items as $item) { ?>
                            <tr class="pull-center-trend"">
                                ...
                                <td>
                                <img width="90px" src="<?php echo base_url("uploads/{$viewFolder}/$item->image_url"); ?>" alt="<?php echo $item->name ." " .$item->surname ; ?>" class="img-responsive">
                                </td>
                                <td><?php echo $item->email; ?></td>
                                <td><?php echo $item->name . " " . $item->surname; ?></td>
                                <td><?php echo $item->gsm1 . "<br>" . $item->gsm2; ?></td>
                                <td><?php echo dateTimeStamp($item->createdAt); ?></td>
                                <td>
                                    ...
                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
                                        ...
                                        type="checkbox" 
                                        data-url="<?php echo base_url("admin/users/isActiveSetter/$item->id"); ?> " 
                                ...
                                <td>
                                    <button data-url="<?php echo base_url("admin/users/delete/$item->id"); ?>" class="btn btn-xs btn-outline-danger mb-1 remove-btn-sweet  default">
                                        <i class="glyph-icon simple-icon-trash"></i> Sil
                                    </button>

                                    <!-- Düzenleme için id'yi göndermek gereklidir. -->
                                    <a href="<?php echo base_url("admin/users/updateForm/$item->id") ?>" class="btn btn-xs btn-outline-secondary mb-1 default"><i class="simple-icon-note"></i> Düzenle</a>
                                    <a href="<?php echo base_url("admin/users/updatePasswordForm/$item->id") ?>" class="btn btn-xs btn-outline-dark mb-1 default"><i class="iconsminds-key"></i> Şifre Değiştir</a>
