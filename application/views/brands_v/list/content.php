    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="top-right-button-container">
                <a class="btn btn-outline-success btn-md " aria-haspopup="true" aria-expanded="false" href="<?php echo base_url("admin/brands/new_form"); ?>">
                            ...
                            <tr class="pull-center-trend" id="ord-<?php echo $item->id; ?>">
                                ...
                                <td>
                                    ...
                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
                                        ...
                                        type="checkbox" 
                                        data-url="<?php echo base_url("admin/brands/isActiveSetter/$item->id"); ?> " 
                                ...
                                <td>
                                    <button data-url="<?php echo base_url("admin/brands/delete/$item->id"); ?>" class="btn btn-xs btn-outline-danger mb-1 remove-btn-sweet">
                                        <i class="glyph-icon simple-icon-trash"></i> Sil
                                    </button>

                                    <!-- Düzenleme için id'yi göndermek gereklidir. -->
                                    <a href="<?php echo base_url("admin/brands/updateForm/$item->id") ?>" class="btn btn-xs btn-outline-secondary mb-1"><i class="simple-icon-note"></i> Düzenle</a>
                                </td>
