    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="top-right-button-container">
                <a class="btn btn-outline-success btn-md " aria-haspopup="true" aria-expanded="false" href="<?php echo base_url("admin/customers/new_form"); ?>">
                    ...
                    <tbody class="sortable">
                        ...
                        foreach ($items as $item) { ?>
                            <tr class="pull-center-trend" id="ord-<?php echo $item->id; ?>">
                                ...
                                <!-- <td></?php echo getJobName($item->jobID); ?></td> -->
                                <td>

                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">

                                        <input class=" isActive custom-switch-input" id="switchS<?php echo $item->id ?>" type="checkbox" data-url="<?php echo base_url("admin/customers/isActiveSetter/$item->id"); ?> " <?php echo ($item->isActive) ? "checked" : ""; ?> />
                                ...
                                <td>
                                    <button data-url="<?php echo base_url("admin/customers/delete/$item->id"); ?>" class="btn btn-xs btn-outline-danger mb-1 remove-btn-sweet">
                                        <i class="glyph-icon simple-icon-trash"></i> Sil
                                    </button>

                                    <!-- Düzenleme için id'yi göndermek gereklidir. -->
                                    <a href="<?php echo base_url("admin/customers/updateForm/$item->id") ?>" class="btn btn-xs btn-outline-secondary mb-1"><i class="simple-icon-note"></i> Düzenle</a>
                                </td>
