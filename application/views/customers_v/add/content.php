<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1>Yeni Müşteri Ekleme İşlemi</h1>
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="mb-4">Yeni Müşteri Bilgileri</h5>

                    <form action="<?php echo base_url("admin/customer/save"); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlychar" value="<?php echo isset($formError) ? set_value("name") : " " ?>" name="name" placeholder="Müşterinin İsmi...">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlychar" name="surname" value="<?php echo isset($formError) ? set_value("surname") : " " ?>" placeholder="Müşterinin Soyismi...">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control" name="birthday" value="<?php echo isset($formError) ? set_value("birthday") : " " ?>" placeholder="Doğum tarihini seçiniz.">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="gender" class="form-control">
                                    ...
                                    <option value="0" <?php echo (isset($formError) ? set_select("gender",0):" ")?>> Kadın</option>
                                    <option value="1" <?php echo (isset($formError) ? set_select("gender",1):" ")?>> Erkek </option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="jobID" required class="form-control">
                                    <option value="">Meslek seçiniz...</option>
                                    <?php
                                    foreach (getJob()->result() as $data) { ?>
                                        <option value= "<?php echo $data->id; ?>"
                                        <?php echo (isset($formError) ? set_select("jobID",$data->id):" ")?> > 
                                            <?php echo $data->name?>  
                                        </option>";
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" name="email"  value="<?php echo isset($formError) ? set_value("email") : " " ?>" placeholder="Personelin e-mail adresini Yazınız(Zorunlu Değildir).">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control phone" name="gsm1" value="<?php echo isset($formError) ? set_value("gsm1") : " " ?>"  placeholder="Cep Telefon Yazınız.">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control phone" name="gsm2" value="<?php echo isset($formError) ? set_value("gsm2") : " " ?>" placeholder="Cep Telefon Yazınız(Zorunlu Değildir).">
                                <small class="form-text text-muted">Müşterinin cep telefon numarasını giriniz.</small>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div>
                                    <textarea class="form-control" rows="5" name="description"><?php echo isset($formError) ? set_value("description") : " " ?></textarea>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control password" name="password"  placeholder="Müşteri Şifresini Yazınız.">
                                </div>
