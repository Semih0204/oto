...
class Type extends CI_Controller
{
    ...
    public function save()
    {
        ...
        //Kurallar Yazılır
        $this->form_validation->set_rules("name", "Tür Adı", "required|trim");
        ...
        if ($validate) {
            ...
            $insert = $this->type_model->add($data);
    ...
    public function update($id)
    {
        ...
        if ($validate) {
            ...
            $update = $this->type_model->update(array("id" => $id), $data);
